function Login() {
  return (
    <div className="w-full min-w-[1000px] h-full flex flex-col items-center gap-[20px]">
      ...
      <div className="relative flex flex-col items-center justify-center gap-[20px] w-[400px] max-[600px] bg-main-rgba rounded-[20px] p-[20px]">
        ...
        <a className="self-end mr-[46px] text-white text-[15px] pb-[5px] hover:text-[#ff6072] cursor-pointer">go to signup</a>
      </div>
    </div>
  );
}
